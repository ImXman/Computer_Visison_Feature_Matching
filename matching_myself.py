...
#kp2, des2 = sift.detectAndCompute(gray_close2,None)
...
heat=sns.heatmap(img_cp,cmap="RdBu")
heat.get_figure().savefig("kmeanscluster.jpeg",dpi=1200)
img_cp[img_cp!=1]=0
...
#ori1 = fm.ori_points(img_close_re,p1)
#ori2 = fm.ori_points(img_close2_re,p2)
#des1 = fm.points_descriptor(img_close_re,common,ori1)
#des1 = fm.points_descriptor(img_close_re,p1,ori1)
#des2 = fm.points_descriptor(img_close2_re,p2,ori2)

des1 = sift.compute(img_close_re,kp1)[1]
des2 = sift.compute(img_close2_re,kp2)[1]
...
draw_params = dict(matchColor = (0,255,0),
                   ...
                   flags = 0)
matching = cv2.drawMatches(img_close_re,kp1,img_close2_re,kp2,None, None,**draw_params)
#matching = cv2.drawMatches(img_close_re,kp1,img_close2_re,kp2,good, None,**draw_params)
